...
namespace DynamicsAdapter.Web.Mapping
{
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<ContractTaxIncomeInformation, TaxIncomeInformationEntity>()
                .ForMember(dest => dest.TaxTraceStatusText, opt => opt.MapFrom(src => src.TaxTraceStatusText))
                .ForMember(dest => dest.TaxYearResult, opt => opt.MapFrom(src => src.TaxYear))
                ...
                .ForMember(dest => dest.Date1, opt => opt.MapFrom(src => src.Date))
                .ForMember(dest => dest.JCACode, opt => opt.MapFrom(src => src.JCACode))
                .ForMember(dest => dest.Form, opt => opt.MapFrom(src => src.Form))
                .ForMember(dest => dest.Date2, opt => opt.MapFrom<ContractDateResolver>())
                .ForMember(dest => dest.Date1Label, opt => opt.MapFrom<ContractDateLabelResolver>())
                .ForMember(dest => dest.Date2Label, opt => opt.MapFrom<ContractDateLabelResolver2>())
                .ForMember(dest => dest.StateCode, opt => opt.MapFrom(src => 0))
                .ForMember(dest => dest.StatusCode, opt => opt.MapFrom(src => 1))
            ...
            CreateMap<ContractTaxIncomeInformation, FinancialOtherIncomeEntity>()
                .ForMember(dest => dest.TaxTraceStatusText, opt => opt.MapFrom(src => src.TaxTraceStatusText))
                .ForMember(dest => dest.TaxYear, opt => opt.MapFrom(src => src.TaxYear))
                .ForMember(dest => dest.Date, opt => opt.MapFrom(src => src.Date))
                .ForMember(dest => dest.DateLabel, opt => opt.MapFrom(src => "Date"))
                .ForMember(dest => dest.StateCode, opt => opt.MapFrom(src => 0))
                .ForMember(dest => dest.StatusCode, opt => opt.MapFrom(src => 1))
                .ForMember(dest => dest.Description, opt => opt.MapFrom(src => src.Description != null ? src.Description : (src.TaxCode != null ? src.TaxCode.Code : null)))
                .ForMember(dest => dest.TaxAmount, opt => opt.MapFrom(src => src.TaxCode != null ? src.TaxCode.Value : null))
                .ForMember(dest => dest.Form, opt => opt.MapFrom(src => src.Form))
                .ForMember(dest => dest.JCACode, opt => opt.MapFrom(src => src.JCACode));

            CreateMap<TaxIncomeInformation, FinancialOtherIncomeEntity>()
                .ForMember(dest => dest.TaxTraceStatusText, opt => opt.MapFrom(src => src.TaxTraceStatusText))
                .ForMember(dest => dest.TaxYear, opt => opt.MapFrom(src => src.TaxYear))
            ...
            CreateMap<BankInfo, BankingInformationEntity>()
                ...
                .IncludeBase<PersonalInfo, DynamicsEntity>()
                .ReverseMap()
                .ForMember(dest => dest.BankName, opt => opt.MapFrom(src => src.CouldNotLocate ? Constants.CouldNotLocate : src.BankName))
            ...
            CreateMap<SSG_Employment, Employer>()
                ...
                .ForMember(dest => dest.Name, opt => opt.MapFrom(src => src.CouldNotLocate ? Constants.CouldNotLocate : src.BusinessName))
            ...
            CreateMap<SSG_Asset_RealEstateProperty, RealEstateProperty>()
                ...
                .ForMember(dest => dest.LegalDescription, opt => opt.MapFrom(src => src.CouldNotLocate ? Constants.CouldNotLocate : src.LegalDescription))
            ...
            CreateMap<SSG_SearchRequestResponse, Person>()
               ...
               .ForMember(dest => dest.TaxIncomeInformations, opt => opt.MapFrom<TaxIncomeInformationsCombinedResolver>())
