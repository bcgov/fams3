   ...
   public  class PersonSearchCompletedConsumerTest
    {
        ...
        public void Should_send_the_initial_message_to_the_consumer()
        {
            ...
            _searchApiNotifierMock.Verify(x => x.NotifyEventAsync(It.Is<Guid>(x => x == _requestId), It.IsAny<PersonSearchCompleted>(), It.IsAny<string>(), It.IsAny<CancellationToken>()), Times.Once);
        }
    }
}
