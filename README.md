...
## Project Structure
    ...
    |    └── DynamicsAdapter    # Dynamics Adapter
...
FAMS-dynamics-adapter is a dotnet core rest service that polls dynamics and execute search by posting to search api.

### Tracing

The Dynamics Adapter uses [opentracing](https://opentracing.io/) instrumentation for distributed tracing.
...
```shell
cd app/DynamicsAdapter/DynamicsAdapter.Web
dotnet run
```
